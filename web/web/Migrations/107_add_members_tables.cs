...
namespace web.Migrations
{
    ...
    public class _107_add_members_tables:Migration
    {
        ...
        {
            string tablepath = System.Web.HttpContext.Current.Server.MapPath("/Query/107_create_Member_Registration.sql");
            Execute.Script(tablepath);

            string insertValue = System.Web.HttpContext.Current.Server.MapPath("/Query/107_insert_value_member_registration.sql");
