...
GO
UPDATE MemberField SET Name=N'Business Management and Grow',NepaliName=N'Business Management and Grow'
WHERE TRIM(Name)=N'Capital Increase'
GO

GO
UPDATE MemberField SET Name=N'Administration And Accounting',NepaliName=N'Administration And Accounting'
...
GO
UPDATE Occupation SET Name=N'Nurse',NepaliName=N'Nurse' WHERE LOWER(Name)=N'other'
GO
...
GO
INSERT INTO Country(Name,NepaliName,Status,IsOutsideNepal)
...
GO
UPDATE Member SET IsActive=1 WHERE MemberId=1
GO
